...
class CustomCrop extends Component {
  ...
  createPanResponser(corner, type) {
    return PanResponder.create({
      ...
      onPanResponderMove: (e, gestureState) => {
        ...
        if (
          corner.x._value + gestureState.dx < viewImageDistanceX &&
          corner.y._value + gestureState.dy < 0
        ) {
          corner.setOffset({
            x: -(corner.x._value - viewImageDistanceX),
            y: -corner.y._value,
          });
        }
        ...
        // X MORE AND Y LESS
          ...
          corner.x._value + gestureState.dx > viewImageDistanceX + width &&
          corner.y._value + gestureState.dy < 0
        ) {
          corner.setOffset({
            x: width + viewImageDistanceX - corner.x._value,
            y: -corner.y._value,
          });
        }
        ...
        // X LESS AND Y MORE
          ...
          corner.x._value + gestureState.dx < viewImageDistanceX &&
          corner.y._value + gestureState.dy > height
        ) {
          corner.setOffset({
            x: -(corner.x._value - viewImageDistanceX),
            y: height - corner.y._value,
          });
        }
        ...
        // X MORE
          ...
          corner.x._value + gestureState.dx >
          viewImageDistanceX + width
        ) {
          corner.setOffset({
            x: width + viewImageDistanceX - corner.x._value,
            y: gestureState.dy,
  ...
  render() {
    ...
    if (containerHeight) {
      return (
        <View style={[s(this.props).cropContainer]}>
          <Image
            style={[
              s(this.props).image,
